...
from scripts.data.prepare_subtraction_traces import SubtractionTraceConfig, format_subtraction_trace, random_examples
from scripts.eval.evaluate_addition_trace_forced import answer_span, pad_sequences, replace_oov
from scripts.eval.evaluate_addition_trace_lm import load_model, model_logits


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Fast teacher-forced subtraction trace evaluation.")
